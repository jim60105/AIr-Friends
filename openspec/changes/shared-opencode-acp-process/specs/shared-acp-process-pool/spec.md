...
- **THEN** its `XDG_DATA_HOME` SHALL be `{dataRoot}/opencode-data/discord/123` and its `TMPDIR` SHALL be `{dataRoot}/channel-tmp/discord/123`, both outside any user's per-user workspace
