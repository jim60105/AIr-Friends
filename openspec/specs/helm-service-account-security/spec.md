# Spec: Helm ServiceAccount Security

## Purpose

Define the Helm chart configuration for Kubernetes ServiceAccount management, enabling secure-by-default deployment by disabling automatic ServiceAccount token mounting while providing opt-in ServiceAccount creation and binding.
